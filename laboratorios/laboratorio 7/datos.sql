...
insert into cliente (dui, pais, denominacion, tipo) values ('01234567-8','sv','Carlos Juarez','Institución académica');
insert into cliente (dui, pais, denominacion, tipo) values ('12345678-9','es','Andreu Oliva','Institución académica');
insert into cliente (dui, pais, denominacion, tipo) values ('23456789-0','sv','María Isabel Rodríguez','Institución pública');
insert into cliente (dui, pais, denominacion, tipo) values ('34567890-1','hn','Guillermo Pérez','Empresa');
insert into cliente (dui, pais, denominacion, tipo) values ('45678901-2','ni','Mario Gómez','Empresa');
insert into cliente (dui, pais, denominacion, tipo) values ('56789012-3','bz','Charly Alley','Empresa');
insert into cliente (dui, pais, denominacion, tipo) values ('67890123-4','cr','Eduardo Solórzano','Empresa');
insert into cliente (dui, pais, denominacion, tipo) values ('78901234-5','cr','Manuel Goreiro','Empresa');
insert into cliente (dui, pais, denominacion, tipo) values ('89012345-6','pa','Kevin Ojst','Empresa');
insert into cliente (dui, pais, denominacion, tipo) values ('90123456-7','gt','Mario Simon','Empresa');
insert into cliente (dui, pais, denominacion, tipo) values ('01123456-7','ni','Yey Yey Simon','Empresa');
insert into cliente (dui, pais, denominacion, tipo) values ('11234567-8','bz','Kevin Jimson','Empresa');
